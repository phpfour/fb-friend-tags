...
4. Click **Load unpacked** and select the `fb-friend-tags` folder.
5. Pin the extension to the toolbar (Extensions puzzle icon → pin "Friend Tags for Facebook") so the tag manager is one click away.
